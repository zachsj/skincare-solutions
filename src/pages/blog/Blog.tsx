    ...
    <>
      ...
      <BaseLayout>
        <main>
          ...
          <p className="text"><p> If you are looking for tips for glowing skin, you've come to the right place.
            ...
            <p>When it comes to daytime skin protection, I am absolutely in love with
              &nbsp;<a className="links" href="https://www.ulta.com/p/dramatically-different-hydrating-jelly-moisturizer-xlsImpprod18711071?sku=2531783" target="_blank">
            ...
            <p>I’ve recently discovered <a className="links" href="https://www.ulta.com/p/moisture-surge-face-spray-thirsty-skin-relief-xlsImpprod10791823?sku=2260643" target="_blank">
              ...
              &nbsp;<a className="links" href="https://www.ulta.com/p/travel-size-moisture-surge-face-spray-thirsty-skin-relief-pimprod2021154?sku=2574626" target="_blank">
                travel size version
              </a>
            ...
            <p>For my nighttime routine, I went through a phase where I tried to use all sorts of retinol and anti-aging creams on
              ...
              and
              &nbsp;<a className="links" href="https://www.ulta.com/p/moisture-surge-intense-72h-lipid-replenishing-hydrator-moisturizer-pimprod2018283?sku=2568219" target="_blank">
            ...
            <p>I consider the <a className="links" href="https://www.ulta.com/p/all-about-clean-liquid-facial-soap-mild-xlsImpprod10791729?sku=2153910" target="_blank">All About Clean Mild Liquid Face Soap</a>
              &nbsp; to be the best face wash I have ever used.
              I use this daily and have yet to have any issues with it, but I would be curious to try their <a className="links" href=
            ...
            <p>
              ...
              &nbsp;<a className="links" href="https://www.ulta.com/p/rinse-off-eye-makeup-remover-solvent-xlsImpprod10791751?sku=2153848" target="_blank">
            ...
            <p>
              ...
              &nbsp;<a className="links" href="https://www.clinique.ca/product/1673/4992/skincare/cleansersmakeup-removers/naturally-gentle-eye-makeup-remover" target="_blank">
            ...
            <p>
              ...
              &nbsp;<a className="links" href="https://www.ulta.com/p/even-better-clinical-radical-dark-spot-corrector-interrupter-serum-pimprod2013580?sku=2560142" target="_blank">
